...
namespace Sanbt\Jobs\Controller\Adminhtml\Department;
...
class Edit extends Action
{
    ...
    {
        return $this->_authorization->isAllowed('Sanbt_Jobs::department_save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Sanbt_Jobs::department')
